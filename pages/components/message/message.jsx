export default function alert() {
  ...
  <div className="p-6 bg-black rounded-lg rounded-r-lg">
    <div className="flex items-center">
      <h3 className="text-white font-medium">This site is not done yet, i'm testing out AWS.</h3>
      <button className="ml-auto">
        <svg className="text-white" width="12" height="12" viewbox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
